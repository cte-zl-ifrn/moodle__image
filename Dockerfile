...
RUN curl -o d.zip https://moodle.org/plugins/download.php/22786/availability_xp_moodle41_2020110900.zip && unzip -o d.zip \
    ...
    && curl -o d.zip https://moodle.org/plugins/download.php/29762/availability_relativedate_moodle42_2023081000.zip && unzip -o d.zip \
    && rm d.zip
...
RUN    curl https://codeload.github.com/cte-zl-ifrn/moodle__local_suap/tar.gz/refs/tags/0.2.051t        | tar -zx && mv moodle__local_suap-* local/suap \
